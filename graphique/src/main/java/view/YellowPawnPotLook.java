...
public class YellowPawnPotLook extends TableLook {
    ...
    public YellowPawnPotLook(int cellHeight, int cellWidth, ContainerElement containerElement) {
        super(containerElement, -1, 2, Color.YELLOW);
        countText = new Text();
    ...
    private void updatePawnCount() {
        ...
        countText.setText("Jaunes: " + count + " pions");
